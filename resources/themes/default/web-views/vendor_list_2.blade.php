            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ec-vendor-card">
                            <div class="ec-vendor-card-avtar">
                                <img src="{{asset('public/frontend-assets') }}/images/common/1.jpg" alt="vendor img">
                                <a href="javascript:void(0)" class="btn btn-primary">follow</a>
                                <div class="ec-vendor-card-img">
                                    <img src="{{asset('public/frontend-assets') }}/images/vendor/1.jpg" alt="vendor img">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ec-vendor-card">
                            <div class="ec-vendor-card-avtar">
                                <img src="{{asset('public/frontend-assets') }}/images/common/2.jpg" alt="vendor img">
                                <a href="javascript:void(0)" class="btn btn-primary">follow</a>
                                <div class="ec-vendor-card-img">
                                    <img src="{{asset('public/frontend-assets') }}/images/vendor/2.jpg" alt="vendor img">
                                </div>
                            </div>
                            <div class="ec-vendor-card-info">
                                <a href="catalog-single-vendor.html">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ec-vendor-card">
                            <div class="ec-vendor-card-avtar">
                                <img src="{{asset('public/frontend-assets') }}/images/common/3.jpg" alt="vendor img">
                                <a href="javascript:void(0)" class="btn btn-primary">follow</a>
                                <div class="ec-vendor-card-img">
                                    <img src="{{asset('public/frontend-assets') }}/images/vendor/3.jpg" alt="vendor img">
                                </div>
                            </div>
                            <div class="ec-vendor-card-info">
                                <a href="catalog-single-vendor.html">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ec-vendor-card">
                            <div class="ec-vendor-card-avtar">
                                <img src="{{asset('public/frontend-assets') }}/images/common/4.jpg" alt="vendor img">
                                <a href="javascript:void(0)" class="btn btn-primary">follow</a>
                                <div class="ec-vendor-card-img">
                                    <img src="{{asset('public/frontend-assets') }}/images/vendor/4.jpg" alt="vendor img">
                                </div>
                            </div>
                            <div class="ec-vendor-card-info">
                                <a href="catalog-single-vendor.html">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ec-vendor-card">
                            <div class="ec-vendor-card-avtar">
                                <img src="{{asset('public/frontend-assets') }}/images/common/5.jpg" alt="vendor img">
                                <a href="javascript:void(0)" class="btn btn-primary">follow</a>
                                <div class="ec-vendor-card-img">
                                    <img src="{{asset('public/frontend-assets') }}/images/vendor/5.jpg" alt="vendor img">
                                </div>
                            </div>
                            <div class="ec-vendor-card-info">
                                <a href="catalog-single-vendor.html">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ec-vendor-card">
                            <div class="ec-vendor-card-avtar">
                                <img src="{{asset('public/frontend-assets') }}/images/common/6.jpg" alt="vendor img">
                                <a href="javascript:void(0)" class="btn btn-primary">follow</a>
                                <div class="ec-vendor-card-img">
                                    <img src="{{asset('public/frontend-assets') }}/images/vendor/4.jpg" alt="vendor img">
                                </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ec-vendor-card">
                            <div class="ec-vendor-card-avtar">
                                <img src="{{asset('public/frontend-assets') }}/images/common/7.jpg" alt="vendor img">
                                <a href="javascript:void(0)" class="btn btn-primary">follow</a>
                                <div class="ec-vendor-card-img">
                                    <img src="{{asset('public/frontend-assets') }}/images/vendor/2.jpg" alt="vendor img">
                                </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ec-vendor-card">
                            <div class="ec-vendor-card-avtar">
                                <img src="{{asset('public/frontend-assets') }}/images/common/8.jpg" alt="vendor img">
                                <a href="javascript:void(0)" class="btn btn-primary">follow</a>
                                <div class="ec-vendor-card-img">
                                    <img src="{{asset('public/frontend-assets') }}/images/vendor/1.jpg" alt="vendor img">
                                </div>
