                        ...
                        <div class="ec-vendor-card-body">
                            <div class="ec-vendor-card-table">
                                <table class="table ec-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/vendor/1.jpg"
                                        ...
                                        <tr>
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/vendor/2.jpg"
                                                    alt="product image"></td>
                                        ...
                                        <tr>
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/vendor/3.jpg"
                                                    alt="product image"></td>
                                        ...
                                        <tr>
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/vendor/4.jpg"
                                                    alt="product image"></td>
                                        ...
                                        <tr>
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/vendor/5.jpg"
                                                    alt="product image"></td>
