<!--=========================================================
 ...
 <head>
    ...
    <!-- site Favicon -->
    <link rel="icon" href="{{asset('public/frontend-assets') }}/images/favicon/favicon-2.png" sizes="32x32" />
    <link rel="apple-touch-icon" href="{{asset('public/frontend-assets') }}/images/favicon/favicon-2.png" />
    <meta name="msapplication-TileImage" content="{{asset('public/frontend-assets') }}/images/favicon/favicon-2.png" />
    ...
    <!-- Main Style -->
    <link rel="stylesheet" href="{{asset('public/frontend-assets') }}/css/demo2.css" />
...
<body>
                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center ec-header-logo">
                            <div class="header-logo">
                                <a href="{{url('/')}}"><img src="{{asset('public/frontend-assets') }}/images/logo/logo-2.png" alt="Site Logo" /><img
                                        class="dark-logo" src="{{asset('public/frontend-assets') }}/images/logo/dark-logo-2.png" alt="Site Logo"
                                        ...
                                        <li>
                                            <ul class="ec-main-banner w-100">
                                                <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img
                                                            ...
                                                            src="{{asset('public/frontend-assets') }}/images/menu-banner/5.jpg" alt=""></a>
                                                </li>
                                                <li><a class="p-0" href="shop-left-sidebar-col-4.html"><img
                                                            class="img-responsive"
                                                            src="{{asset('public/frontend-assets') }}/images/menu-banner/6.jpg" alt=""></a>
                                                </li>
                                                <li><a class="p-0" href="shop-right-sidebar-col-3.html"><img
                                                            class="img-responsive"
                                                            src="{{asset('public/frontend-assets') }}/images/menu-banner/7.jpg" alt=""></a>
                                                </li>
                                                <li><a class="p-0" href="shop-right-sidebar-col-4.html"><img
                                                            class="img-responsive"
                                                            src="{{asset('public/frontend-assets') }}/images/menu-banner/8.jpg" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="{{asset('public/frontend-assets') }}/images/product-image/6_1.jpg" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="{{asset('public/frontend-assets') }}/images/product-image/3_1.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="{{asset('public/frontend-assets') }}/images/product-image/4_1.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                ...
                <div class="ec_cat_slider">
                        ...
                        <div class="ec_cat_inner">
                            <a href="shop-left-sidebar-col-3.html">
                                ...
                                <div class="ec-cat-image">
                                    <img src="{{asset('public/frontend-assets') }}/images/category-image/1.svg" class="svg_img cat_svg" alt="" />
                                </div>
                    ...
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <a href="shop-left-sidebar-col-3.html">
                                <div class="ec-cat-image">
                                    <img src="{{asset('public/frontend-assets') }}/images/category-image/2.svg" class="svg_img cat_svg" alt="" />
                                </div>
                                <div class="ec-cat-desc">
                    ...
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <a href="shop-left-sidebar-col-3.html">
                                <div class="ec-cat-image">
                                    <img src="{{asset('public/frontend-assets') }}/images/category-image/3.svg" class="svg_img cat_svg" alt="" />
                                </div>
                                <div class="ec-cat-desc">
                    ...
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <a href="shop-left-sidebar-col-3.html">
                                <div class="ec-cat-image">
                                    <img src="{{asset('public/frontend-assets') }}/images/category-image/4.svg" class="svg_img cat_svg" alt="" />
                                </div>
                                <div class="ec-cat-desc">
                    ...
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <a href="shop-left-sidebar-col-3.html">
                                <div class="ec-cat-image">
                                    <img src="{{asset('public/frontend-assets') }}/images/category-image/5.svg" class="svg_img cat_svg" alt="" />
                                </div>
                                <div class="ec-cat-desc">
                    ...
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <a href="shop-left-sidebar-col-3.html">
                                <div class="ec-cat-image">
                                    <img src="{{asset('public/frontend-assets') }}/images/category-image/6.svg" class="svg_img cat_svg" alt="" />
                                </div>
                                <div class="ec-cat-desc">
                    ...
                    <div class="ec-banner-inner">
                        <div class="ec-banner-block ec-banner-block-4 mar-b-30">
                            <div class="banner-block">
                                <img src="{{asset('public/frontend-assets') }}/images/banner/13.jpg" alt="" />
                        ...
                        <div class="ec-banner-block ec-banner-block-5">
                            <div class="banner-block">
                                <img src="{{asset('public/frontend-assets') }}/images/banner/14.jpg" alt="" />
                                <div class="banner-content">
                                    <div class="banner-text">
                                        <span class="ec-banner-discount">Big Discount</span>
                            ...
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image" src="{{asset('public/frontend-assets') }}/images/product-image/1_1.jpg"
                                            alt="Product" />
                                        <img class="hover-image" src="{{asset('public/frontend-assets') }}/images/product-image/1_2.jpg"
                                            alt="Product" />
                                    </a>
                    ...
                    <div class="ec-product-content">
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image" src="{{asset('public/frontend-assets') }}/images/product-image/2_1.jpg"
                                            alt="Product" />
                                        <img class="hover-image" src="{{asset('public/frontend-assets') }}/images/product-image/2_2.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="percentage">-30%</span>
                                    <span class="flags">
                            ...
                            <div class="ec-pro-content">
                                ...
                                <div class="ec-pro-option">
                                    <div class="ec-pro-color">
                                        <ul class="ec-opt-swatch ec-change-img">
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/2_2.jpg"
                    ...
                    <div class="ec-product-content">
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image" src="{{asset('public/frontend-assets') }}/images/product-image/3_1.jpg"
                                            alt="Product" />
                                        <img class="hover-image" src="{{asset('public/frontend-assets') }}/images/product-image/3_2.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="percentage">-30%</span>
                                    <span class="flags">
                            ...
                            <div class="ec-pro-content">
                                ...
                                <div class="ec-pro-option">
                                    <div class="ec-pro-color">
                                        <ul class="ec-opt-swatch ec-change-img">
                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/3_1.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/3_1.jpg"
                                                    data-tooltip="Gray"><span
                                                        style="background-color:#86c1f5;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/3_2.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/3_2.jpg"
                                                    data-tooltip="Orange"><span
                                                        style="background-color:#71d6c8;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/3_3.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/3_3.jpg"
                                                    data-tooltip="Green"><span
                                                        style="background-color:#81d48e;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/3_4.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/3_4.jpg"
                                                    data-tooltip="Sky Blue"><span
                    ...
                    <div class="ec-product-content">
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image" src="{{asset('public/frontend-assets') }}/images/product-image/4_1.jpg"
                                            alt="Product" />
                                        <img class="hover-image" src="{{asset('public/frontend-assets') }}/images/product-image/4_2.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="percentage">-30%</span>
                                    <span class="flags">
                            ...
                            <div class="ec-pro-content">
                                ...
                                <div class="ec-pro-option">
                                    <div class="ec-pro-color">
                                        <ul class="ec-opt-swatch ec-change-img">
                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/4_1.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/4_1.jpg"
                                                    data-tooltip="Gray"><span
                                                        style="background-color:#b48059;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/4_2.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/4_2.jpg"
                                                    data-tooltip="Orange"><span
                                                        style="background-color:#71a06b;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/4_3.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/4_3.jpg"
                                                    data-tooltip="Green"><span
                                                        style="background-color:#64c2da;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/4_4.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/4_4.jpg"
                                                    data-tooltip="Sky Blue"><span
                    ...
                    <div class="ec-product-content">
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image" src="{{asset('public/frontend-assets') }}/images/product-image/5_1.jpg"
                                            alt="Product" />
                                        <img class="hover-image" src="{{asset('public/frontend-assets') }}/images/product-image/5_2.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="percentage">-30%</span>
                                    <span class="flags">
                            ...
                            <div class="ec-pro-content">
                                ...
                                <div class="ec-pro-option">
                                    <div class="ec-pro-color">
                                        <ul class="ec-opt-swatch ec-change-img">
                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/5_1.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/5_1.jpg"
                                                    data-tooltip="Gray"><span
                                                        style="background-color:#272727;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/5_2.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/5_2.jpg"
                                                    data-tooltip="Orange"><span
                    ...
                    <div class="ec-product-content">
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image" src="{{asset('public/frontend-assets') }}/images/product-image/6_1.jpg"
                                            alt="Product" />
                                        <img class="hover-image" src="{{asset('public/frontend-assets') }}/images/product-image/6_2.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="percentage">-30%</span>
                                    <span class="flags">
                            ...
                            <div class="ec-pro-content">
                                ...
                                <div class="ec-pro-option">
                                    <div class="ec-pro-color">
                                        <ul class="ec-opt-swatch ec-change-img">
                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/6_1.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/6_1.jpg"
                                                    data-tooltip="Gray"><span
                                                        style="background-color:#acbadf;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/6_2.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/6_2.jpg"
                                                    data-tooltip="Orange"><span
                    ...
                    <div class="ec-product-content">
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image" src="{{asset('public/frontend-assets') }}/images/product-image/7_1.jpg"
                                            alt="Product" />
                                        <img class="hover-image" src="{{asset('public/frontend-assets') }}/images/product-image/7_2.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="percentage">-30%</span>
                                    <span class="flags">
                    ...
                    <div class="ec-product-content">
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image" src="{{asset('public/frontend-assets') }}/images/product-image/8_1.jpg"
                                            alt="Product" />
                                        <img class="hover-image" src="{{asset('public/frontend-assets') }}/images/product-image/8_2.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="percentage">-30%</span>
                                    <span class="flags">
                            ...
                            <div class="ec-pro-content">
                                ...
                                <div class="ec-pro-option">
                                    <div class="ec-pro-color">
                                        <ul class="ec-opt-swatch ec-change-img">
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/8_2.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/8_2.jpg"
                                                    data-tooltip="Orange"><span
                                                        style="background-color:#adadad;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/8_3.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/8_3.jpg"
                                                    data-tooltip="Green"><span
                                                        style="background-color:#d1b5d0;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/8_4.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/8_4.jpg"
                                                    data-tooltip="Sky Blue"><span
                    ...
                    <div class="ec-product-content">
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image" src="{{asset('public/frontend-assets') }}/images/product-image/9_1.jpg"
                                            alt="Product" />
                                        <img class="hover-image" src="{{asset('public/frontend-assets') }}/images/product-image/9_2.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="percentage">-30%</span>
                                    <span class="flags">
                            ...
                            <div class="ec-pro-content">
                                ...
                                <div class="ec-pro-option">
                                    <div class="ec-pro-color">
                                        <ul class="ec-opt-swatch ec-change-img">
                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/9_1.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/9_1.jpg"
                                                    data-tooltip="Gray"><span
                                                        style="background-color:#5d7bff;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/9_2.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/9_2.jpg"
                                                    data-tooltip="Orange"><span
                                                        style="background-color:#a3d3ff;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/9_3.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/9_3.jpg"
                                                    data-tooltip="Green"><span
                                                        style="background-color:#7dffc2;"></span></a></li>
                                            <li><a href="#" class="ec-opt-clr-img"
                                                    data-src="{{asset('public/frontend-assets') }}/images/product-image/9_4.jpg"
                                                    data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/9_4.jpg"
                                                    data-tooltip="Sky Blue"><span
    ...
    <section class="section ec-offer-section section-space-mt section-space-mb">
        ...
        <img src="{{asset('public/frontend-assets') }}/images/offer-image/offer_bg_2.jpg" alt="" class="offer_bg" />
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 ec-product-content">
                                    <div class="ec-product-inner">
                                            ...
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/11_1.jpg"
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/11_2.jpg"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">-25%</span>
                                                <button title="Add To Cart" class=" add-to-cart"><img
                                                        src="{{asset('public/frontend-assets') }}/images/icons/pro_cart.svg"
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Women's fashion leather purse</a></h5>
                                            <span class="ec-price">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/11_1.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/11_1.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#765fb4;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/11_2.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/11_2.jpg"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#cc66b3;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/11_3.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/11_3.jpg"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#668d5c;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/11_4.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/11_4.jpg"
                                                                data-tooltip="Sky Blue"><span
                                                ...
                                                <div class="ec-pro-size">
                                                    <ul class="ec-opt-size">
                                                        ...
                                                        <li><a href="#" class="ec-opt-sz" data-old="$89.00"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/12_1.jpg"
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/12_2.jpg"
                                                        alt="Product" />
                                                </a>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Women's heel shoes</a></h5>
                                            <span class="ec-price">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/12_1.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/12_1.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#8c04fc;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/12_2.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/12_2.jpg"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#52afae;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/12_3.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/12_3.jpg"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#cc6daa;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/12_4.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/12_4.jpg"
                                                                data-tooltip="Sky Blue"><span
                                                ...
                                                <div class="ec-pro-size">
                                                    <ul class="ec-opt-size">
                                                        ...
                                                        <li><a href="#" class="ec-opt-sz" data-old="$110.00"
                                                                data-new="$90.00" data-tooltip="Medium">7</a></li>
                                                        <li><a href="#" class="ec-opt-sz" data-old="$150.00"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/13_1.jpg"
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/13_2.jpg"
                                                        alt="Product" />
                                                </a>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/13_1.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/13_1.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#6a8b36;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/13_2.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/13_2.jpg"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#b9754f;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/13_3.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/13_3.jpg"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#bd669d;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/13_4.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/13_4.jpg"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/14_1.jpg"
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/14_2.jpg"
                                                        alt="Product" />
                                                </a>
                                                <button title="Add To Cart" class=" add-to-cart"><img
                                                        src="{{asset('public/frontend-assets') }}/images/icons/pro_cart.svg"
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Boys casual shoes</a></h5>
                                            <span class="ec-price">
                                                <span class="new-price">$399.00</span>
                                                <span class="old-price">$450.00</span>
                                            </span>
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/14_1.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/14_1.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#d5c29a;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/14_2.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/14_2.jpg"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#c7d3a5;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/14_3.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/14_3.jpg"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#a0dacb;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/14_4.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/14_4.jpg"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/15_1.jpg"
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/15_2.jpg"
                                                        alt="Product" />
                                                </a>
                                                <span class="flags">
                                                    <span class="sale">New</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Baby cotton shoes</a></h5>
                                            <span class="ec-price">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/15_1.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/15_1.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#fa6ffb;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/15_2.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/15_2.jpg"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#66c3f5;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/15_3.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/15_3.jpg"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#58cf47;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/15_4.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/15_4.jpg"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/16_1.jpg"
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/16_2.jpg"
                                                        alt="Product" />
                                                </a>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/16_1.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/16_1.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#08e5fb;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/16_2.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/16_2.jpg"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#fb8cfc;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/16_3.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/16_3.jpg"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#fbae40;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/16_4.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/16_4.jpg"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/17_1.jpg"
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/17_2.jpg"
                                                        alt="Product" />
                                                </a>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Shopping bag for womens</a></h5>
                                            <span class="ec-price">
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/18_1.jpg"
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/18_2.jpg"
                                                        alt="Product" />
                                                </a>
                                                <span class="flags">
                                                    <span class="sale">New</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/18_1.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/18_1.jpg"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#5e6778;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/18_2.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/18_2.jpg"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#d38d85;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/18_3.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/18_3.jpg"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#c7b899;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('public/frontend-assets') }}/images/product-image/18_4.jpg"
                                                                data-src-hover="{{asset('public/frontend-assets') }}/images/product-image/18_4.jpg"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/1_1.jpg"
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('public/frontend-assets') }}/images/product-image/1_2.jpg"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">-30%</span>
                                                <span class="flags">
            ...
            <div class="row">
                <div class="col-md-12 text-center ec-test-top">
                    <div class="ec-test-top-svg">
                        ...
                        <img src="{{asset('public/frontend-assets') }}/images/testimonial/quotes-2.svg" class="svg_img test_top_svg" alt="" />
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="ec-test-outer">
                    <ul id="ec-testimonial-slider">
                        <li class="ec-test-item">
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="{{asset('public/frontend-assets') }}/images/testimonial/4.jpg" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-desc"><img src="{{asset('public/frontend-assets') }}/images/testimonial/top-quotes-2.svg"
                                            class="svg_img test_svg top" alt="" /> Lorem Ipsum is simply dummy text of
                                        the printing and typesetting industry. Lorem Ipsum has been the industry's
                                        standard dummy text ever since the 1500s, when an unknown printer took a galley
                                        of type and scrambled it to make a type specimen book. It has survived not only
                                        five centuries, but also the leap into electronic typesetting, remaining
                                        essentially unchanged. It was popularised in <img
                                            src="{{asset('public/frontend-assets') }}/images/testimonial/bottom-quotes.svg"
                        ...
                        <li class="ec-test-item">
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="{{asset('public/frontend-assets') }}/images/testimonial/5.jpg" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-desc"><img src="{{asset('public/frontend-assets') }}/images/testimonial/top-quotes-2.svg"
                                            class="svg_img test_svg top" alt="" /> Lorem Ipsum is simply dummy text of
                                        the printing and typesetting industry. Lorem Ipsum has been the industry's
                                        ...
                                        five centuries, but also the leap into electronic typesetting, remaining
                                        essentially unchanged. It was popularised in <img
                                            src="{{asset('public/frontend-assets') }}/images/testimonial/bottom-quotes-2.svg"
                                            class="svg_img test_svg bottom" alt="" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="ec-test-item">
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="{{asset('public/frontend-assets') }}/images/testimonial/6.jpg" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-desc"><img src="{{asset('public/frontend-assets') }}/images/testimonial/top-quotes-2.svg"
                                            class="svg_img test_svg top" alt="" /> Lorem Ipsum is simply dummy text of
                                        the printing and typesetting industry. Lorem Ipsum has been the industry's
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('public/frontend-assets') }}/images/product-image/2_1.jpg"
                                        alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('public/frontend-assets') }}/images/product-image/2_2.jpg"
                                        alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('public/frontend-assets') }}/images/product-image/2_3.jpg"
                                        alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('public/frontend-assets') }}/images/product-image/2_2.jpg"
    ...
    <div class="ec-float-chat">
        <div class="ec-chat-icon">
            <img class="svg_img ec-float-img" src="{{asset('public/frontend-assets') }}/images/chatboat/livechat.svg" alt="chatboat" />
        </div>
    </div>
    <!-- Chat Boat end -->
    ...
    <script src="{{asset('public/frontend-assets') }}/js/plugins/chat-boat.js"></script>

    <!-- Main Js -->
    <script src="{{asset('public/frontend-assets') }}/js/vendor/index.js"></script>
    <script src="{{asset('public/frontend-assets') }}/js/demo-2.js"></script>
