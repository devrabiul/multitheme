<!--=========================================================
 ...
 <head>
    ...
    <!-- Main Style -->
    <link rel="stylesheet" href="assets/css/demo3.css" />
...
<body>
                    ...
                    <div class="col header-top-res d-lg-none">
                        <div class="ec-header-bottons">
                            ...
                            <a href="#ec-side-cart" class="ec-header-btn ec-side-toggle">
                                <div class="header-icon"><img src="assets/images/icons/pro_cart.svg"
                                        class="svg_img header_svg" alt="" /></div>
                    ...
                    <div class="header-bottom-flex">
                        ...
                        <div class="align-self-center ec-header-logo ">
                            <div class="header-logo">
                                <a href="{{url('/')}}"><img src="assets/images/logo/logo-3.png"
        ...
        <div class="ec-header-bottom d-lg-none">
            <div class="container position-relative">
                <div class="row ">
                    ...
                    <div class="col">
                        <div class="header-logo">
                            <a href="{{url('/')}}"><img src="assets/images/logo/logo-3.png" alt="Site Logo" /><img
                                        ...
                                        <li>
                                            <ul class="ec-main-banner w-100">
                                                <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img
                                                            ...
                                                            src="assets/images/menu-banner/9.jpg" alt=""></a>
                                                </li>
                                                <li><a class="p-0" href="shop-left-sidebar-col-4.html"><img
                                                            class="img-responsive"
                                                            src="assets/images/menu-banner/10.jpg" alt=""></a>
                                                </li>
                                                <li><a class="p-0" href="shop-right-sidebar-col-3.html"><img
                                                            class="img-responsive"
                                                            src="assets/images/menu-banner/11.jpg" alt=""></a>
                                                </li>
                                                <li><a class="p-0" href="shop-right-sidebar-col-4.html"><img
                                                            class="img-responsive"
                                                            src="assets/images/menu-banner/12.jpg" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
            ...
            <div class="row">
                <div class="ec_cat_slider">
                    ...
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <div class="ec-cat-image">
                                <img src="assets/images/category-image/5.jpg" alt="" />
                            </div>
                            <div class="ec-cat-desc">
                                <span class="ec-section-btn"><a href="shop-left-sidebar-col-3.html" class="btn-primary">Sofa chair</a></span>
                            </div>
                                                ...
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="assets/images/product-image/19_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="assets/images/product-image/19_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="assets/images/product-image/20_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="assets/images/product-image/20_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                    <div class="ec-pro-actions">
                                                        <button title="Add To Cart" class=" add-to-cart"><img
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="assets/images/product-image/21_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="assets/images/product-image/21_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="flags">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="assets/images/product-image/22_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="assets/images/product-image/22_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="flags">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="assets/images/product-image/23_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="assets/images/product-image/23_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="flags">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="assets/images/product-image/24_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="assets/images/product-image/24_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                    <div class="ec-pro-actions">
                                                        <button title="Add To Cart" class=" add-to-cart"><img
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="assets/images/product-image/25_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="assets/images/product-image/25_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="flags">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="assets/images/product-image/26_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="assets/images/product-image/26_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="flags">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="assets/images/product-image/27_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="assets/images/product-image/27_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                    <div class="ec-pro-actions">
                                                        <button title="Add To Cart" class=" add-to-cart"><img
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="assets/images/product-image/28_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="assets/images/product-image/28_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                    <div class="ec-pro-actions">
                                                        <button title="Add To Cart" class=" add-to-cart"><img
                    ...
                    <ul class="ec-brand-inner">
                        <li class="ec-brand-item col-lg-3 col-md-4 col-sm-4">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="assets/images/brand-image/9.jpg" /></a></div>
                        </li>
                        <li class="ec-brand-item col-lg-3 col-md-4 col-sm-4">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="assets/images/brand-image/10.jpg" /></a></div>
                        </li>
                        <li class="ec-brand-item col-lg-3 col-md-4 col-sm-4">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="assets/images/brand-image/11.jpg" /></a></div>
                        </li>
                        <li class="ec-brand-item col-lg-3 col-md-4 col-sm-4">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="assets/images/brand-image/12.jpg" /></a></div>
                        </li>
                        <li class="ec-brand-item col-lg-3 col-md-4 col-sm-4">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="assets/images/brand-image/13.jpg" /></a></div>
                        </li>
                        <li class="ec-brand-item col-lg-3 col-md-4 col-sm-4">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="assets/images/brand-image/14.jpg" /></a></div>
                        </li>
                        <li class="ec-brand-item col-lg-3 col-md-4 col-sm-4">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="assets/images/brand-image/15.jpg" /></a></div>
                        </li>
                        <li class="ec-brand-item col-lg-3 col-md-4 col-sm-4">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="assets/images/brand-image/16.jpg" /></a></div>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="col-sm-12 col-lg-3 ec-footer-contact">
                            <div class="ec-footer-widget">
                                <div class="ec-footer-logo"><a href="#"><img
                                            src="assets/images/logo/footer-logo-3.png" alt=""><img
    ...
    <div class="ec-fb-style fb-right-bottom">
        ...
        <div class="fb-panel">
            <!-- Panel Content -->
            <div class="fb-header">
                <img src="assets/images/user/1.jpg" alt="pic" />
                <h2>Maria Mark</h2>
