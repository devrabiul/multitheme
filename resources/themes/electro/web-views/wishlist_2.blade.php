                            ...
                            <div class="ec-vendor-card-table">
                                <table class="table ec-table">
                                    ...
                                    <tbody class="wish-empt">
                                        <tr class="pro-gl-content">
                                            ...
                                            <td><span class="tbl-btn">
                                                <a class="btn btn-lg btn-primary" href="javascript:void(0)" title="Add To Cart">
                                                    <img src="{{asset('public/frontend-assets') }}/images/icons/pro_cart.svg" class="svg_img pro_svg" alt="" />
                                                </a>
                                        ...
                                        <tr class="pro-gl-content">
                                            <th scope="row"><span>225</span></th>
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/product-image/5.jpg"
                                                    alt="product image"></td>
                                        ...
                                        <tr class="pro-gl-content">
                                            <th scope="row"><span>548</span></th>
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/product-image/6.jpg"
                                                    alt="product image"></td>
                                        ...
                                        <tr class="pro-gl-content">
                                            <th scope="row"><span>684</span></th>
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/product-image/7.jpg"
                                                    alt="product image"></td>
