...
<body class="shop_page">
                                    ...
                                    <div class="ec-vendor-block-profile">
                                        <div class="ec-vendor-block-img space-bottom-30">
                                            ...
                                            <div class="ec-vendor-block-detail">
                                                <img class="v-img" src="{{asset('public/frontend-assets') }}/images/vendor/5.jpg" alt="vendor image">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="ec-vendor-detail-block ec-vendor-block-email space-bottom-30">
                                                    <h6>E-mail address <a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{asset('public/frontend-assets') }}/images/icons/edit.svg"
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="ec-vendor-detail-block ec-vendor-block-contact space-bottom-30">
                                                    <h6>Contact nubmer<a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{asset('public/frontend-assets') }}/images/icons/edit.svg"
                                                        class="svg_img pro_svg" alt="edit" /></a></h6>
                                                    <ul>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="ec-vendor-detail-block ec-vendor-block-address mar-b-30">
                                                    <h6>Address<a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{asset('public/frontend-assets') }}/images/icons/edit.svg"
                                                        class="svg_img pro_svg" alt="edit" /></a></h6>
                                                    <ul>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="ec-vendor-detail-block ec-vendor-block-contact">
                                                    <h6>Tax Information<a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{asset('public/frontend-assets') }}/images/icons/edit.svg"
                                                        class="svg_img pro_svg" alt="edit" /></a></h6>
                                                    <ul>
                        ...
                        <div class="ec-vendor-block-img space-bottom-30">
                                ...
                                <div class="thumb-upload">
                                    <div class="thumb-edit">
                                        <input type='file' id="thumbUpload01" class="ec-image-upload"
                                            accept=".png, .jpg, .jpeg" />
                                        <label><img src="{{asset('public/frontend-assets') }}/images/icons/edit.svg"
                                                class="svg_img header_svg" alt="edit" /></label>
                                    </div>
                                    <div class="thumb-preview ec-preview">
                                        <div class="image-thumb-preview">
                                            <img class="image-thumb-preview ec-image-preview v-img"
                                                src="{{asset('public/frontend-assets') }}/images/banner/7.jpg" alt="edit" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="ec-vendor-block-detail">
                                <div class="thumb-upload">
                                    ...
                                    <div class="thumb-preview ec-preview">
                                        <div class="image-thumb-preview">
                                            <img class="image-thumb-preview ec-image-preview v-img"
                                                src="{{asset('public/frontend-assets') }}/images/vendor/5.jpg" alt="edit" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="ec-vendor-upload-detail">
                                <form class="row g-3">
                                    ...
                                    <div class="col-md-6 space-t-15">
                                        <label class="form-label">Tax ID Name</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="col-md-6 space-t-15">
                                        <label class="form-label">SSN OR EIN</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="col-md-6 space-t-15">
                                        ...
                                        <select name="categories" class="form-select">
                                            ...
                                            <option value="prtnership">Prtnership</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 space-t-15">
                                        <label class="form-label">Bank Name</label>
                                        <select name="categories" class="form-select">
                                            <option value="bobob">Bank of BOBOB</option>
                                            <option value="sbisb">Bank of SBISB</option>
                                            <option value="bnktolyo">Bank of Tokyo</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 space-t-15">
    ...
    <script src="{{asset('public/frontend-assets') }}/js/vendor/bootstrap-tagsinput.js"></script>
