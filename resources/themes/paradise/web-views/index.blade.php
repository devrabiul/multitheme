<!--=========================================================
 ...
 <head>
    ...
    <!-- site Favicon -->
    <link rel="icon" href="{{asset('public/frontend-assets') }}/images/favicon/favicon-9.png" sizes="32x32" />
    <link rel="apple-touch-icon" href="{{asset('public/frontend-assets') }}/images/favicon/favicon-9.png" />
    <meta name="msapplication-TileImage" content="{{asset('public/frontend-assets') }}/images/favicon/favicon-9.png" />
    ...
    <!-- Main Style -->
    <link rel="stylesheet" href="{{asset('public/frontend-assets') }}/css/demo9.css" />
...
<body>
                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center">
                            <div class="header-logo">
                                <a href="{{url('/')}}"><img src="{{asset('public/frontend-assets') }}/images/logo/logo-9.png" alt="Site Logo" /><img
                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="{{asset('public/frontend-assets') }}/images/product-image/113_1.jpg" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="{{asset('public/frontend-assets') }}/images/product-image/114_1.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="{{asset('public/frontend-assets') }}/images/product-image/125_1.jpg" alt="product"></a>
                        <div class="ec-pro-content">
    ...
    <section class="section ec-about-sec section-space-p">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="ec-about">
                        <img src="{{asset('public/frontend-assets') }}/images/about/about.png" alt="about-image">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="ec-about-detail">
                        <h4>Bring power to your steps.</h4>
            ...
            <div class="row margin-minus-b-15 margin-minus-t-15">
                ...
                <div class="ec_cat_content ec_cat_content_1">
                    <div class="ec_cat_inner ec_cat_inner-1">
                        <div class="ec-category-image">
                            <img src="{{asset('public/frontend-assets') }}/images/icons/category-1.svg" class="svg_img" alt="drink" />
                        </div>
                ...
                <div class="ec_cat_content ec_cat_content_2">
                    <div class="ec_cat_inner ec_cat_inner-2">
                        <div class="ec-category-image">
                            <img src="{{asset('public/frontend-assets') }}/images/icons/category-2.svg" class="svg_img" alt="drink" />
                        </div>
                        <div class="ec-category-desc">
                ...
                <div class="ec_cat_content ec_cat_content_3">
                    <div class="ec_cat_inner ec_cat_inner-3">
                        <div class="ec-category-image">
                            <img src="{{asset('public/frontend-assets') }}/images/icons/category-3.svg" class="svg_img" alt="drink" />
                        </div>
                        <div class="ec-category-desc">
                ...
                <div class="ec_cat_content ec_cat_content_4">
                    <div class="ec_cat_inner ec_cat_inner-4">
                        <div class="ec-category-image">
                            <img src="{{asset('public/frontend-assets') }}/images/icons/category-4.svg" class="svg_img" alt="drink" />
                        </div>
                        <div class="ec-category-desc">
                ...
                <div class="ec_cat_content ec_cat_content_5">
                    <div class="ec_cat_inner ec_cat_inner-5">
                        <div class="ec-category-image">
                            <img src="{{asset('public/frontend-assets') }}/images/icons/category-5.svg" class="svg_img" alt="drink" />
                        </div>
                        <div class="ec-category-desc">
                ...
                <div class="ec_cat_content ec_cat_content_6">
                    <div class="ec_cat_inner ec_cat_inner-6">
                        <div class="ec-category-image">
                            <img src="{{asset('public/frontend-assets') }}/images/icons/category-6.svg" class="svg_img" alt="drink" />
                        </div>
                        <div class="ec-category-desc">
                ...
                <div class="ec_cat_content ec_cat_content_7">
                    <div class="ec_cat_inner ec_cat_inner-7">
                        <div class="ec-category-image">
                            <img src="{{asset('public/frontend-assets') }}/images/icons/category-7.svg" class="svg_img" alt="drink" />
                        </div>
                        <div class="ec-category-desc">
                ...
                <div class="ec_cat_content ec_cat_content_8">
                    <div class="ec_cat_inner ec_cat_inner-8">
                        <div class="ec-category-image">
                            <img src="{{asset('public/frontend-assets') }}/images/icons/category-8.svg" class="svg_img" alt="drink" />
                        </div>
                        <div class="ec-category-desc">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/123_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/123_1.jpg" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/114_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/114_2.jpg" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/124_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/124_1.jpg" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/121_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/121_2.jpg" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{asset('public/frontend-assets') }}/images/icons/pro_wishlist.svg"
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/113_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/113_2.jpg" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{asset('public/frontend-assets') }}/images/icons/pro_wishlist.svg"
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/115_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/115_1.jpg" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/116_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/116_1.jpg" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/117_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/117_2.jpg" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                                            <span class="new">New</span>
                                                        </span>
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/118_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/118_2.jpg" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                                            <span class="sale">Sale</span>
                                                        </span>
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/119_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/119_2.jpg" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{asset('public/frontend-assets') }}/images/icons/pro_wishlist.svg"
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/120_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/120_2.jpg" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{asset('public/frontend-assets') }}/images/icons/pro_wishlist.svg"
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/122_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/122_2.jpg" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                                            <span class="sale">Sale</span>
                                                        </span>
                                                    ...
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/115_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/115_2.jpg" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{asset('public/frontend-assets') }}/images/icons/pro_wishlist.svg"
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/101_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/101_2.jpg" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                                            <span class="sale">Sale</span>
                                                        </span>
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/125_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/125_1.jpg" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/126_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/126_1.jpg" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/127_1.jpg" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/127_1.jpg" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
    ...
    <div id="ec-popnews-box">
        ...
        <div class="row">
            <div class="col-md-7 disp-no-767">
                <img src="{{asset('public/frontend-assets') }}/images/banner/newsletter-9.png" alt="newsletter">
            </div>
            <div class="col-md-5">
    ...
    <div class="recent-purchase">
        <img src="{{asset('public/frontend-assets') }}/images/product-image/102_1.jpg" alt="payment image">
        <div class="detail">
    ...
    <script src="{{asset('public/frontend-assets') }}/js/demo-9.js"></script>
</body>
