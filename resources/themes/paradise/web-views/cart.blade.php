                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td data-label="Product" class="ec-cart-pro-name"><a
                                                            href="product-left-sidebar.html"><img class="ec-cart-pro-img mr-4"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/1.jpg"
                                                ...
                                                <tr>
                                                    <td data-label="Product" class="ec-cart-pro-name"><a
                                                            href="product-left-sidebar.html"><img class="ec-cart-pro-img mr-4"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/2.jpg"
                                                ...
                                                <tr>
                                                    <td data-label="Product" class="ec-cart-pro-name"><a
                                                            href="product-left-sidebar.html"><img class="ec-cart-pro-img mr-4"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/3.jpg"
                                                ...
                                                <tr>
                                                    <td data-label="Product" class="ec-cart-pro-name"><a
                                                            href="product-left-sidebar.html"><img class="ec-cart-pro-img mr-4"
                                                                src="{{asset('public/frontend-assets') }}/images/product-image/4.jpg"
