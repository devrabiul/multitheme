...
<body class="shop_page">
                                ...
                                <table class="table ec-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/product-image/1.jpg"
                                        ...
                                        <tr>
                                            ...
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/product-image/2.jpg"
                                                    alt="product image"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/product-image/3.jpg"
                                                    alt="product image"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img class="prod-img" src="{{asset('public/frontend-assets') }}/images/product-image/4.jpg"
                                                    alt="product image"></td>
    ...
    <script src="{{asset('public/frontend-assets') }}/js/plugins/chart.min.js"></script>
    ...
    <!-- Main Js -->
    <script src="{{asset('public/frontend-assets') }}/js/chart-main.js"></script>
