...
<body class="checkout_page">
                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center">
                            <div class="header-logo">
                                <a href="{{url('/')}}"><img src="{{asset('public/frontend-assets') }}/images/logo/logo.png" alt="Site Logo" /><img
                                        class="dark-logo" src="{{asset('public/frontend-assets') }}/images/logo/dark-logo.png" alt="Site Logo"
        ...
        <div class="ec-cart-inner">
            <div class="ec-cart-top">
                ...
                <ul class="eccart-pro-items">
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{asset('public/frontend-assets') }}/images/product-image/12_1.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{asset('public/frontend-assets') }}/images/product-image/8_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="{{asset('public/frontend-assets') }}/images/product-image/8_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                </div>
                                            </div>
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image"
                                        src="{{asset('public/frontend-assets') }}/images/product-image/6_1.jpg" alt="Product" />
                                    <img class="hover-image"
                                        src="{{asset('public/frontend-assets') }}/images/product-image/6_2.jpg" alt="Product" />
                                </a>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-3 ec-footer-contact">
                            <div class="ec-footer-widget">
                                <div class="ec-footer-logo"><a href="#"><img src="{{asset('public/frontend-assets') }}/images/logo/footer-logo.png"
                                            alt=""><img class="dark-footer-logo" src="{{asset('public/frontend-assets') }}/images/logo/dark-logo.png"
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('public/frontend-assets') }}/images/product-image/3_1.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('public/frontend-assets') }}/images/product-image/3_2.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('public/frontend-assets') }}/images/product-image/3_3.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('public/frontend-assets') }}/images/product-image/3_4.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('public/frontend-assets') }}/images/product-image/3_5.jpg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="quickview-pro-content">
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <div class="ec-quickview-cart ">
                                        <button class="btn btn-primary"><img src="{{asset('public/frontend-assets') }}/images/icons/cart.svg"
            ...
            <div class="ec-nav-panel">
                <div class="ec-nav-panel-icons">
                    <a href="#ec-mobile-menu" class="navbar-toggler-btn ec-header-btn ec-side-toggle"><img
                            src="{{asset('public/frontend-assets') }}/images/icons/menu.svg" class="svg_img header_svg" alt="" /></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="#ec-side-cart" class="toggle-cart ec-header-btn ec-side-toggle"><img
                            src="{{asset('public/frontend-assets') }}/images/icons/cart.svg" class="svg_img header_svg" alt="" /><span
                ...
                <div class="ec-nav-panel-icons">
                    <a href="{{url('/customer/login')}}" class="ec-header-btn"><img src="{{asset('public/frontend-assets') }}/images/icons/user.svg"
                            class="svg_img header_svg" alt="icon" /></a>
                </div>
                        ...
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                ...
                                <div class="ec-img-cont">
                                    <img src="{{asset('public/frontend-assets') }}/images/whatsapp/profile_01.jpg" class="ec-user-img"
                                        alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{asset('public/frontend-assets') }}/images/whatsapp/profile_02.jpg" class="ec-user-img"
                                        alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{asset('public/frontend-assets') }}/images/whatsapp/profile_03.jpg" class="ec-user-img"
                                        alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{asset('public/frontend-assets') }}/images/whatsapp/profile_04.jpg" class="ec-user-img"
                                        alt="Profile image">
                                    <span class="ec-status-icon ec-offline"></span>
                                </div>
                                <!-- Display Name & Last Seen -->
        ...
        <div class="ec-right-bottom">
            <div class="ec-box">
                <div class="ec-button rotateBackward">
                    <img class="whatsapp" src="{{asset('public/frontend-assets') }}/images/common/whatsapp.png" alt="whatsapp icon" />
                </div>
            </div>
        </div>
    ...
    <div class="ec-tools-sidebar">
        ...
        <a href="#" class="ec-tools-sidebar-toggle in-out">
            <img alt="icon" src="{{asset('public/frontend-assets') }}/images/common/settings.png" />
        </a>
