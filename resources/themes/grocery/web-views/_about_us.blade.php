...
<body class="aboutus_page">
                ...
                <div class="ec-common-wrapper">
                    <div class="row">
                        <div class="col-md-6 ec-cms-block ec-abcms-block text-center">
                            ...
                            <img class="a-img" src="{{asset('public/frontend-assets') }}/images/offer-image/1.jpg" alt="about">
                            </div>
                        </div>
                        <div class="col-md-6 ec-cms-block ec-abcms-block text-center">
                            <div class="ec-cms-block-inner">
                ...
                <div class="ec-test-outer">
                    <ul id="ec-testimonial-slider">
                        <li class="ec-test-item">
                            <img src="{{asset('public/frontend-assets') }}/images/testimonial/top-quotes.svg" class="svg_img test_svg top" alt="" />
                            ...
                            <img src="{{asset('public/frontend-assets') }}/images/testimonial/bottom-quotes.svg" class="svg_img test_svg bottom"
                                alt="" />
                        </li>
                        <li class="ec-test-item">
                            <img src="{{asset('public/frontend-assets') }}/images/testimonial/top-quotes.svg" class="svg_img test_svg top" alt="" />
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ec_ser_content ec_ser_content_4 col-sm-12 col-md-6 col-lg-3">
                    <div class="ec_ser_inner">
                        <div class="ec-service-image">
                            <img src="{{asset('public/frontend-assets') }}/images/icons/service_4.svg" class="svg_img" alt="" />
                        </div>
                        <div class="ec-service-desc">
            ...
            <div class="ec-insta-outer">
                <div class="container">
                    <div class="insta-auto">
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="{{asset('public/frontend-assets') }}/images/instragram-image/6.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="{{asset('public/frontend-assets') }}/images/instragram-image/7.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
    ...
    <div class="ec-cart-float">
        <a href="#ec-side-cart" class="ec-header-btn ec-side-toggle">
            <div class="header-icon"><img src="{{asset('public/frontend-assets') }}/images/icons/cart.svg" class="svg_img header_svg" alt="cart" />
            </div>
