            ...
            <div class="row">
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="ec-payment-content">
                            ...
                            <ul>
                                <li><i class="ecicon eci-check-circle-o"></i>Lorem Ipsum is simply dummy text of the printing</li>
                                <li><i class="ecicon eci-check-circle-o"></i>Lorem Ipsum is simply dummy text of the printing</li>
                                <li><i class="ecicon eci-check-circle-o"></i>Lorem Ipsum is simply dummy text of the printing</li>
                                <li><i class="ecicon eci-times-circle-o"></i>Lorem Ipsum is simply dummy text of the printing</li>
                                <li><i class="ecicon eci-times-circle-o"></i>Lorem Ipsum is simply dummy text of the printing</li>
                            </ul>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <img src="{{asset('public/frontend-assets') }}/images/common/payment-fail.jpg" alt="payment">
                    </div>
                </div>
            </div>
        </div>
