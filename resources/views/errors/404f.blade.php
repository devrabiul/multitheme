<!--=========================================================
 ...
 <head>
	 ...
	 <title>404 {{ env('APP_NAME')?'| '.env('APP_NAME'): '' }}</title>
...
<body>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="under-maintenance">
						...
						<a href="{{ url('/') }}" class="btn btn-lg btn-primary" tabindex="0">Back to Home</a>
					</div>
				</div>
				<div class="col-md-6 disp-768">
					<div class="under-maintenance">
						<img class="maintenance-img" src="{{ theme_asset('assets') }}/images/common/404.png" alt="maintenance">
					</div>
				</div>
			</div>
		</div>
	...
	<script src="{{ theme_asset('assets') }}/js/plugins/coming-soon.js"></script>
