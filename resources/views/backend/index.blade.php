...
<head>
	...
	<!-- PLUGINS CSS STYLE -->
	<link href="{{ asset('public/admin-assets') }}/plugins/daterangepicker/daterangepicker.css" rel="stylesheet">
	<link href="{{ asset('public/admin-assets') }}/plugins/simplebar/simplebar.css" rel="stylesheet" />

	<!-- Ekka CSS -->
	<link id="ekka-css" href="{{ asset('public/admin-assets') }}/css/ekka.css" rel="stylesheet" />
...
<body class="ec-header-fixed ec-sidebar-fixed ec-sidebar-light ec-header-light" id="body">
			...
			<div id="sidebar" class="sidebar ec-sidebar-footer">
				...
				<div class="ec-brand">
					<a href="{{url('/')}}" title="Ekka">
						<img class="ec-brand-icon" src="{{ asset('public/admin-assets') }}/img/logo/ec-site-logo.png" alt="" />
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown user-menu">
								<button class="dropdown-toggle nav-link ec-drop" data-bs-toggle="dropdown"
									aria-expanded="false">
									<img src="{{ asset('public/admin-assets') }}/img/user/user.png" class="user-image" alt="User Image" />
								</button>
								<ul class="dropdown-menu dropdown-menu-right ec-dropdown-menu">
									<!-- User image -->
									<li class="dropdown-header">
										<img src="{{ asset('public/admin-assets') }}/img/user/user.png" class="img-circle" alt="User Image" />
									...
									<li class="dropdown-footer">
										<a href="{{url('/')}}"> <i class="mdi mdi-logout"></i> Log Out </a>
									</li>
								</ul>
							</li>
												...
												<ul class="list-unstyled" data-simplebar style="height: 360px">
													<li>
														<a href="javscript:void(0)"
															...
															<div class="position-relative mr-3">
																<img class="rounded-circle" src="{{ asset('public/admin-assets') }}/img/user/u2.jpg"
																	alt="Image">
													...
													<li>
														<a href="javscript:void(0)"
															...
															<div class="position-relative mr-3">
																<img class="rounded-circle" src="{{ asset('public/admin-assets') }}/img/user/u1.jpg"
																	alt="Image">
													...
													<li>
														<a href="javscript:void(0)"
															class="media media-message media-notification">
															<div class="position-relative mr-3">
																<img class="rounded-circle" src="{{ asset('public/admin-assets') }}/img/user/u5.jpg"
																	alt="Image">
																<span class="status away"></span>
															</div>
															<div class="media-body d-flex justify-content-between">
												...
												<ul class="list-unstyled" data-simplebar style="height: 360px">
													<li>
														<a href="javscript:void(0)"
															class="media media-message media-notification">
															<div class="position-relative mr-3">
																<img class="rounded-circle" src="{{ asset('public/admin-assets') }}/img/user/u6.jpg"
																	alt="Image">
																<span class="status away"></span>
															</div>
															<div class="media-body d-flex justify-content-between">
													...
													<li>
														<a href="javscript:void(0)"
															class="media media-message media-notification">
															<div class="position-relative mr-3">
																<img class="rounded-circle" src="{{ asset('public/admin-assets') }}/img/user/u7.jpg"
																	alt="Image">
																<span class="status away"></span>
															</div>
															<div class="media-body d-flex justify-content-between">
													...
													<div class="media">
														<div class="media-image mr-3 rounded-circle">
															<a href="profile.html"><img
																	...
																	src="{{ asset('public/admin-assets') }}/img/user/u1.jpg"
												...
												<td>
													<div class="media">
														<div class="media-image mr-3 rounded-circle">
															<a href="profile.html"><img
																	class="profile-img rounded-circle w-45"
																	src="{{ asset('public/admin-assets') }}/img/user/u2.jpg"
																	alt="customer image"></a>
														</div>
														<div class="media-body align-self-center">
															<a href="profile.html">
												...
												<td>
													<div class="media">
														<div class="media-image mr-3 rounded-circle">
															<a href="profile.html"><img
																	class="profile-img rounded-circle w-45"
																	src="{{ asset('public/admin-assets') }}/img/user/u3.jpg"
																	alt="customer image"></a>
														</div>
														<div class="media-body align-self-center">
															<a href="profile.html">
												...
												<td>
													<div class="media">
														<div class="media-image mr-3 rounded-circle">
															<a href="profile.html"><img
																	class="profile-img rounded-circle w-45"
																	src="{{ asset('public/admin-assets') }}/img/user/u4.jpg"
																	alt="customer image"></a>
														</div>
														<div class="media-body align-self-center">
															<a href="profile.html">
												...
												<td>
													<div class="media">
														<div class="media-image mr-3 rounded-circle">
															<a href="profile.html"><img
																	class="profile-img rounded-circle w-45"
																	src="{{ asset('public/admin-assets') }}/img/user/u5.jpg"
																	alt="customer image"></a>
														</div>
														<div class="media-body align-self-center">
															<a href="profile.html">
								...
								<div class="card-body mt-10px mb-10px py-0">
									<div class="row media d-flex pt-15px pb-15px">
										<div
											...
											<a href="#"><img src="{{ asset('public/admin-assets') }}/img/products/p1.jpg" alt="customer image"></a>
										</div>
									...
									<div class="row media d-flex pt-15px pb-15px">
										<div
											class="col-lg-3 col-md-3 col-2 media-image align-self-center rounded">
											<a href="#"><img src="{{ asset('public/admin-assets') }}/img/products/p2.jpg" alt="customer image"></a>
										</div>
										<div class="col-lg-9 col-md-9 col-10 media-body align-self-center ec-pos">
											<a href="#">
									...
									<div class="row media d-flex pt-15px pb-15px">
										<div
											class="col-lg-3 col-md-3 col-2 media-image align-self-center rounded">
											<a href="#"><img src="{{ asset('public/admin-assets') }}/img/products/p3.jpg" alt="customer image"></a>
										</div>
										<div class="col-lg-9 col-md-9 col-10 media-body align-self-center ec-pos">
											<a href="#">
	...
	<script src="{{ asset('public/admin-assets') }}/plugins/simplebar/simplebar.min.js"></script>
	...
	<!-- Chart -->
	<script src="{{ asset('public/admin-assets') }}/plugins/charts/Chart.min.js"></script>
	<script src="{{ asset('public/admin-assets') }}/js/chart.js"></script>

	<!-- Google map chart -->
	<script src="{{ asset('public/admin-assets') }}/plugins/charts/google-map-loader.js"></script>
	<script src="{{ asset('public/admin-assets') }}/plugins/charts/google-map.js"></script>

	<!-- Date Range Picker -->
	<script src="{{ asset('public/admin-assets') }}/plugins/daterangepicker/moment.min.js"></script>
    <script src="{{ asset('public/admin-assets') }}/plugins/daterangepicker/daterangepicker.js"></script>
	<script src="{{ asset('public/admin-assets') }}/js/date-range.js"></script>

	<!-- Option Switcher -->
	<script src="{{ asset('public/admin-assets') }}/plugins/options-sidebar/optionswitcher.js"></script>
